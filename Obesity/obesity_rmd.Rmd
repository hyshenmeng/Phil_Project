...
```{r year, message = FALSE, out.width="100%"}
year_tb1 <- data1 %>%
...
## Patient Visits by Census Division

```{r region, message = FALSE, out.width="100%"}
region_tb1 <- data1 %>%
...
```{r gender, message = FALSE, out.width="100%"}
sex_tb1 <- data1 %>%
...
```{r age, message = FALSE, out.width="100%"}
age_tb1 <- data1 %>%
...
```{r race, message = FALSE, out.width="100%"}
race_tb1 <- data1 %>%
